...
L"dialogueBG_hell",
L"mal_idle",
        L"얼씨구, 대가리 빈 멍청이들이 더 왔어... 저 못생긴 놈은 처음보네.",
        L"어디서 놀다온 사람이냐 넌?",
L"",
L"",
0,
...
L"dialogueBG_hell",
L"mal_idle",
        L"대단하네, 또 골빈 빡대가리들이야... 처음 보는 못생긴 놈이군.",
        L"지옥에서 뭘 하고 있어?",
        L"그쪽이랑 게임하고 싶어서 왔지",
        L"정말 좋은데. 제발 날 더 모욕해줘.",
1,
2,
3
        });
...
0
    ...
    //    L"dialogueBG_hell",
    //    L"mal_idle",
    //    L"그쪽이랑 노는게 가장 재밌어 보이는데.",
    //    L"정말 달콤하네. 제발 날 더 모욕해줘.",
    //    1,
    //    });
    ...
    //    L"dialogueBG_hell",
    //    L"mal_puzzled",
    //    L"뭐... 비디오 게임 같은거? 좋지 않을거 있나. 턴제 전투 게임만",
    //    L"좋아한다면 별 상관은 없어",
    //    1,
    //    });
    ...
    //    L"dialogueBG_hell",
    //    L"mal_idle",
    //    L"운도 참 끝내주네. 마죠 변태가 하나 더 늘었어.",
    //    L"",
    //    1,
    //    });

    pObject->diemessage = L"그녀가 손으로 허공을 휘젓더니, 목에서 피가 분수처럼";
    pObject->diemessage2 = L"처참하게 터져 나오기 시작했습니다.";
